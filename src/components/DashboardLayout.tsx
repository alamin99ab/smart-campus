...
const roleNavItems: Record<UserRole, NavItem[]> = {
  ...
  principal: [
    ...
    { label: "Academic Sessions", icon: Calendar, path: "/principal/academic-sessions" },
  ...
  teacher: [
    ...
    { label: "Class Tests", icon: FileText, path: "/teacher/class-tests" },
    { label: "My Routine", icon: Calendar, path: "/teacher/routine" },
  ...
  accountant: [
    ...
    { label: "Exports", icon: FileText, path: "/accountant/exports" },
